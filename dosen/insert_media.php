<form method="POST" action="../backend/process.php?op=insertMediaDsn" class="m-3">
  ...
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Bahan Ajar</label>
    <div class="col-sm-10">
      <select name="id_ba" class="custom-select">
        <?php
