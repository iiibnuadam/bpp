  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      if ($_GET['page'] == 'manage_PROFILE') {
        ...
        $act = "<a href=\"$linkAdd\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\"><i class=\"fas fa-plus fa-sm text-white-50\"></i> Tambah</a>";
      } else if ($_GET['page'] == 'manage_pres') {
        $titledash = " MANAGE PRESENSI";
        $linkAdd = "index.php?page=insert_pres";
        $act = "<a href=\"$linkAdd\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\"><i class=\"fas fa-plus fa-sm text-white-50\"></i> Tambah</a>";
      } else {
        $titledash = "DASHBOARD";
        $linkAdd = "index.php?page=insert_admin";
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Main Dosen:</h6>
            <a class="collapse-item" href="index.php?page=manage_ampu">Matakuliah</a>
