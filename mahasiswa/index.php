...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      if ($_GET['page'] == 'manage_profile') {
        $titledash = " PROFILE";
        $act = "";
      } else if ($_GET['page'] == 'dashboard') {
        $titledash = "DASHBOARD";
        $linkAdd = "index.php?page=dashboard";
        $act = "";
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Main Mahasiswa:</h6>
            <a class="collapse-item" href="index.php?page=manage_mk">Matakuliah</a>
            <a class="collapse-item" href="index.php?page=manage_kur">Kurikulum</a>
            <a class="collapse-item" href="index.php?page=manage_ba">Modul</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="?page=manage_profile">
