...
$sql = "SELECT * FROM `bahan_ajar` WHERE `bahan_ajar`.`id`= '$id'";
$result = $connect->query($sql);
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ?>

    <form method="POST" action="../backend/process.php?op=editBa">
      ...
      <div class="form-group row">
        <label for="inputEmail3" class="col-sm-2 col-form-label">Pembuat</label>
        <div class="col-sm-10">
